    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-[#FDF6F2] to-[#F5DDD0] px-6">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="rounded-2xl bg-white/80 backdrop-blur-sm p-8 shadow-xl border border-white/50">
          ...
          <GoogleSignInButton className="flex w-full items-center justify-center gap-3 rounded-xl bg-white px-4 py-3.5 text-sm font-semibold text-gray-700 shadow-md border border-gray-200 transition-all hover:shadow-lg hover:border-gray-300 active:scale-[0.98]">
